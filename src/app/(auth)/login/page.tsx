    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex flex-1 items-center justify-center p-6 lg:p-12">
        ...
        >
          ...
          >
            <Button variant="outline" className="w-full" size="lg" onClick={() => toast.info("Google Sign-In requires OAuth configuration. Please use phone OTP login.")}>
          ...
          >
            ...
            <button
              onClick={() => toast.info("New users are automatically registered on first OTP login. Just enter your phone number above!")}
